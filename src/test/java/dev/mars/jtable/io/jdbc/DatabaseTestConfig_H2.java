...
/**
 * H2 database configuration that implements IJDBCDataSource.
 * This class provides connection details and methods to initialize and clean up the database.
 */
public class DatabaseTestConfig_H2 implements IJDBCDataSource {
    ...
    /**
     * Gets the connection string for the H2 database.
     *
    ...
    /**
     * Gets the username for the H2 database.
     *
     * @return the username
     */
    ...
    /**
     * Gets the password for the H2 database.
     *
     * @return the password
     */
    ...
    public String getValueAt(int rowIndex, String columnName) {
        ...
        String value = row.get(columnName.toUpperCase());
