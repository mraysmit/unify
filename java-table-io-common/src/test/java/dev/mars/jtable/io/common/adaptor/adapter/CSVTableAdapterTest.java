...
/**
 * Test class for CSVTableAdapter.
 * This class tests that the adapter correctly delegates method calls to the Table instance
 * and implements the ICSVDataSource interface.
 */
class CSVTableAdapterTest {

    private Table table;
    private CSVTableAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new CSVTableAdapter(table);
    }
    ...
    void testImplementsInterfaces() {
        ...
        assertTrue(adapter instanceof ICSVDataSource);
    }
