package dev.mars.jtable.io.common.adaptor.adapter;
...
/**
 * Test class for DataSourceTableAdapter.
 * This class tests that the adapter correctly delegates method calls to the Table instance
 * and implements the IDataSource interface.
 */
class DataSourceTableAdapterTest {

    private Table table;
    private DataSourceTableAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new DataSourceTableAdapter(table);
    }
    ...
    void testImplementsInterfaces() {
        ...
        assertTrue(adapter instanceof IDataSource);
    }
