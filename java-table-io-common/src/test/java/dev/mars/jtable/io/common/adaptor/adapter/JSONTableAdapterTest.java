...
import dev.mars.jtable.io.common.adapter.JSONTableAdapter;
...
/**
 * Test class for JSONTableAdapter.
 * This class tests that the adapter correctly delegates method calls to the Table instance
 * and implements the IJSONDataSource interface.
 */
class JSONTableAdapterTest {
    ...
    void testImplementsInterfaces() {
        ...
        assertTrue(adapter instanceof IJSONDataSource);
    }
