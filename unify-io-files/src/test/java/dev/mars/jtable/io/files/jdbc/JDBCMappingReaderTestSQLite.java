 ...
 * This class tests reading data from a SQLite database using JDBCMappingReader with mapping configurations.
 */
class JDBCMappingReaderTestSQLite {

    private static final String TEST_DB_URL = "jdbc:sqlite:test_sqlite_reader.db";
